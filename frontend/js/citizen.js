...
(function preselectFromQuickReport() {
  let quickCat = null;
  try { quickCat = sessionStorage.getItem("civicvoice_quick_category"); } catch (e) {}
  if (!quickCat) return;
  ...
  try { sessionStorage.removeItem("civicvoice_quick_category"); } catch (e) {}
})();
...
function showResult(data) {
  ...
  card.innerHTML = `
    ...
    <div class="row"><span class="label">Target response</span><span class="value">${c.sla_hours} hrs</span></div>
