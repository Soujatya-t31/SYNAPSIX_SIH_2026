...
We received a request to reset your JanDrishti password.
...
"""
    ...
    <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto;">
      ...
      <p>{greeting}</p>
      <p>We received a request to reset your JanDrishti password.</p>
    ...
    msg["Subject"] = "Reset your JanDrishti password"
    msg["From"] = SMTP_EMAIL
    msg["To"] = to_email
...
Your JanDrishti complaint {complaint_id} ({category}) was just updated to: {status_label}{officer_line}.
...
"""
    ...
    <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto;">
      ...
      <p>Hi,</p>
      <p>Your JanDrishti complaint <b>{complaint_id}</b> ({category}) was just updated to:</p>
